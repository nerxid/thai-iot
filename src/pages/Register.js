    ...
    <div style={{ backgroundColor: "#cde4ff", minHeight: "100vh", paddingTop: "80px", paddingBottom: "80px" }}>
      <div className="container">
              ...
              >
                ...
                <div className="card-body p-4 d-flex flex-column">
                  ...
                  <div className="text-center mb-4">
                    <h5 
                      className={`fw-bold mb-1 ${type.featured ? 'text-white' : 'text-dark'}`}
                    ...
                    {type.subtitle && (
                      <p 
                        className={`small mb-0 ${type.featured ? 'text-white opacity-75' : 'text-muted'}`}
                      >
                        {type.subtitle}
                      </p>
                    )}
                  ...
                  <div className="text-center mb-4">
                    <div 
                      className={`h3 fw-bold mb-1 ${type.featured ? 'text-white' : ''}`}
                      style={{ color: type.featured ? '#fff' : '#2196F3' }}
                    >
                      {type.price}
                    </div>
                    {type.lifetimePrice && (
                      <div 
                        className={`small ${type.featured ? 'text-white opacity-75' : 'text-muted'}`}
                      >
                        {type.lifetimePrice}
                      </div>
                    )}
                  ...
                  <button 
                    ...
                    onMouseEnter={(e) => {
                      if (!type.featured) {
                        e.target.style.background = "linear-gradient(135deg, #1976D2, #1E88E5)";
                      }
                    }}
                    onMouseLeave={(e) => {
                      if (!type.featured) {
                        e.target.style.background = "linear-gradient(135deg, #2196F3, #21CBF3)";
                      }
                    }}
                  >
                    สมัครสมาชิก
                  ...
                  {/* Divider */}
                  <hr 
                    className={`my-3 ${type.featured ? 'border-white opacity-25' : 'border-light'}`}
                    style={{ borderWidth: "2px" }}
                  />

                  {/* Benefits Header */}
                  <h6 
                    className={`fw-bold mb-3 ${type.featured ? 'text-white' : 'text-dark'}`}
                  >
                    สิทธิ์ที่จะได้รับ
                  </h6>
                      ...
                      <li key={i} className="mb-2 d-flex align-items-start">
                        {benefit.startsWith("✘") ? (
                          <>
                            ...
                            <span 
                              className={`${type.featured ? 'text-white opacity-75' : 'text-muted'}`}
                          ...
                          <>
                            ...
                            <span 
                              className={`${type.featured ? 'text-white' : 'text-dark'}`}
        ...
        <div className="text-center mt-5">
          <p className="text-black opacity-75 mb-3">
            มีคำถามเกี่ยวกับการสมัครสมาชิก?
          </p>
          <button 
            className="btn btn-outline-info btn-lg px-4 py-2 text-dark"
            style={{
              borderRadius: "15px",
              borderWidth: "2px",
              transition: "all 0.3s ease"
            ...
            onMouseEnter={(e) => {
              e.target.style.background = "rgb(130, 207, 238)";
