...
const CorporateMemberForm = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "companyCertificate") {
      ...
      if (file.type !== ALLOWED_TYPE || file.size > MAX_SIZE_BYTES) {
        ...
        setFormErrors((prev) => ({
          ...prev,
          companyCertificate: errorMessage,
        }));
        setFormData((prev) => ({ ...prev, companyCertificate: null }));
        e.target.value = null;
        return;
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.paymentType)
      newErrors.paymentType = "กรุณาเลือกประเภทการชำระเงิน";

    setFormErrors(newErrors);

    if (Object.keys(newErrors).length === 0) {
      try {
        // 1. ส่งข้อมูลการลงทะเบียน
        const registrationResponse = await axios.post(
          "http://127.0.0.1:8000/api/accounts/register/",
          {
            title: formData.prefix === "อื่นๆ" ? customPrefix : formData.prefix,
            ...
            membership_type: formData.membershipDuration,
            address: formData.address,
            member_type: "corporate",
            consent_news: formData.acceptNews,
          },
          {
            headers: {
        ...
        if (formData.companyCertificate) {
          ...
          formDataForFile.append("file_url", formData.companyCertificate); // ใช้ 'file' แทน 'file_url'
          formDataForFile.append("document_type", "org_certificate");
          formDataForFile.append("user", userId.toString());
        ...
        console.log("Submitting Corporate Data:", {
          ...formData,
          prefix: formData.prefix === "อื่นๆ" ? customPrefix : formData.prefix,
        });

        setShowConfirmationModal(true);
        alert("สมัครสมาชิกและอัปโหลดไฟล์เรียบร้อยแล้ว!");
      } catch (error) {
        console.error("Error:", {
    ...
    <>
      <div className="card p-4 p-md-5 border-0 shadow-lg membership-form-card">
        <div className="card-body">
          ...
          <p className="card-subtitle text-center text-muted mb-5">
            กรุณากรอกข้อมูลให้ครบถ้วน
          </p>
          <form onSubmit={handleSubmit} noValidate>
            <div className="row g-4">
              <div className="col-md-4">
                <label htmlFor="prefix-corp" className="form-label">
                  คำนำหน้า*
                </label>
                <select
                  id="prefix-corp"
              ...
              {formData.prefix === "อื่นๆ" && (
                <div className="col-md-4">
                  <label htmlFor="custom-prefix-corp" className="form-label">
                    ระบุคำนำหน้า*
                  </label>
                  <input
                    type="text"
                    ...
                    className={`form-control ${
                      formErrors.customPrefix ? "is-invalid" : ""
                    }`}
                    value={customPrefix}
              ...
              <div className="col-md-4">
                <label htmlFor="firstName-corp" className="form-label">
                  ชื่อ*
                </label>
                <input
                  type="text"
              ...
              <div className="col-md-4">
                <label htmlFor="lastName-corp" className="form-label">
                  นามสกุล*
                </label>
                <input
                  type="text"
              ...
              <div className="col-md-6">
                <label htmlFor="companyName-corp" className="form-label">
                  ชื่อบริษัท*
                </label>
                <input
                  type="text"
              ...
              <div className="col-md-6">
                <label htmlFor="position-corp" className="form-label">
                  ตำแหน่ง*
                </label>
                <input
                  type="text"
              ...
              <div className="col-12">
                <label htmlFor="address-corp" className="form-label">
                  ที่อยู่*
                </label>
                <textarea
                  id="address-corp"
              ...
              <div className="col-md-6">
                <label htmlFor="phone-corp" className="form-label">
                  หมายเลขโทรศัพท์*
                </label>
                <input
                  type="tel"
              ...
              <div className="col-md-6">
                <label htmlFor="email-corp" className="form-label">
                  E-mail*
                </label>
                <input
                  type="email"
              ...
              <div className="col-md-6">
                <label htmlFor="lineId-corp" className="form-label">
                  Line-ID*
                </label>
                <input
                  type="text"
                ...
                />
                {formErrors.lineId && (
                  <div className="invalid-feedback">{formErrors.lineId}</div>
                )}
              </div>
              <div className="col-md-6">
                <label htmlFor="password-corp" className="form-label">
                  รหัสผ่าน*
                </label>
                <input
                  type="password"
                ...
                {formErrors.password ? (
                  ...
                  <small className="form-text text-muted">
                    อย่างน้อย 8 ตัวอักษร, ประกอบด้วยตัวพิมพ์เล็ก, พิมพ์ใหญ่,
                    และตัวเลข
                  </small>
                )}
              </div>
              <div className="col-md-6">
                <label htmlFor="confirmPassword-corp" className="form-label">
                  ยืนยันรหัสผ่าน*
                </label>
                <input
                  type="password"
                ...
                <div className="row gy-3">
                  <div className="col-md-6">
                    <div className="membership-duration-option">
                      ...
                      />
                      <label
                        className="form-check-label h-100"
                        htmlFor="initial-corp"
                      >
                        <strong>แรกเข้า</strong>
                        <br />
                        <small className="text-muted">
                          (มีค่าแรกเข้า 1,000 บาท)
                        </small>
                      </label>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="membership-duration-option">
                      <input
                        ...
                        id="renewal-corp"
                        value="renewal"
                        checked={formData.paymentType === "renewal"}
                        onChange={handleChange}
                      />
                      <label
                        className="form-check-label h-100"
                        htmlFor="renewal-corp"
                      >
                        <strong>ต่ออายุ</strong>
                        <br />
                  ...
                  <div className="col-md-6">
                    <div className="membership-duration-option">
                      <input
                        ...
                        id="yearly-corp"
                        value="yearly"
                        checked={formData.membershipDuration === "yearly"}
                        onChange={handleChange}
                      />
                      <label
                        className="form-check-label h-100"
                  ...
                  <div className="col-md-6">
                    <div className="membership-duration-option">
                      <input
                        ...
                        id="lifetime-corp"
                        value="lifetime"
                        checked={formData.membershipDuration === "lifetime"}
                        onChange={handleChange}
                      />
                      <label
                        className="form-check-label h-100"
                        htmlFor="lifetime-corp"
                      >
                        <strong>สมาชิกตลอดชีพ</strong>
                        <br />
                        54,570 บาท (รวม vat 7%)
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-12 mt-4">
                ...
                <input
                  className={`form-control ${
                    formErrors.companyCertificate ? "is-invalid" : ""
                  }`}
                  type="file"
              ...
              <div className="col-12 mt-4">
                ...
                <div className="form-check">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                  />{" "}
                  <label className="form-check-label" htmlFor="acceptNews-corp">
                    {" "}
