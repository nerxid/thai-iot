  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      const response = await axios
        ...
        .then(alert("ส่งข้อมูลการสมัครสมาชิกเรียบร้อย!"))
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="row g-4">
            <div className="col-md-4">
              <label htmlFor="prefix-gen" className="form-label">
                คำนำหน้า*
              </label>
              <select
                id="prefix-gen"
            ...
            {formData.prefix === "อื่นๆ" && (
              <div className="col-md-4">
                <label htmlFor="custom-prefix-gen" className="form-label">
                  ระบุคำนำหน้า*
                </label>
                <input
                  type="text"
                  id="custom-prefix-gen"
            ...
            <div className="col-md-6">
              <label htmlFor="password-gen" className="form-label">
                รหัสผ่าน*
              </label>
              <input
                type="password"
            ...
            <div className="col-md-6">
              <label htmlFor="confirmPassword-gen" className="form-label">
                ยืนยันรหัสผ่าน*
              </label>
              <input
                type="password"
                id="confirmPassword-gen"
