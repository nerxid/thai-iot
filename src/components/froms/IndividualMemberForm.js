...
const IndividualMemberForm = () => {
    const [formData, setFormData] = useState({ prefix: '', firstName: '', lastName: '', companyName: '', position: '', address: '', phone: '', email: '', lineId: '', membershipDuration: 'yearly', acceptNews: false, });
    ...
    const handlePaymentSuccess = () => { console.log('Submitting Individual Member Data:', formData); setShowPaymentModal(false); alert('ส่งข้อมูลการสมัครสมาชิกเรียบร้อย!'); };
    ...
    return (
        <>
            ...
            <PaymentModal show={showPaymentModal} onHide={() => setShowPaymentModal(false)} onSubmit={handlePaymentSuccess} memberType="individual" formData={formData} />
        </>
    );
};
