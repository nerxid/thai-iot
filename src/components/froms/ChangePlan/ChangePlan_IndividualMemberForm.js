...
const ChangePlanIndividualMemberForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const requiredFields = ['prefix', 'firstName', 'lastName', 'address', 'phone', 'email', 'lineId', 'paymentType'];
                                ...
                                <div className="row gy-3">
                                    <div className="col-md-6">
                                        <div className="membership-duration-option">
                                            <input className="form-check-input" type="radio" name="paymentType" id="initial-ind-change" value="initial" checked={formData.paymentType === 'initial'} onChange={handleChange} />
                                            <label className="form-check-label h-100" htmlFor="initial-ind-change">
                                    ...
                                    <div className="col-md-6">
                                        <div className="membership-duration-option">
                                            <input className="form-check-input" type="radio" name="paymentType" id="renewal-ind-change" value="renewal" checked={formData.paymentType === 'renewal'} onChange={handleChange} />
