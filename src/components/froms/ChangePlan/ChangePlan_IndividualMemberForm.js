        ...
        <>
            <div className="card p-4 p-md-5 border-0 shadow-lg membership-form-card">
                <div className="card-body">
                    <h2 className="card-title text-center fw-bold mb-2">แบบฟอร์มขอเปลี่ยนแผนสมาชิก (สมาชิกบุคคลธรรมดา)</h2>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="row g-4">
                            <div className="col-md-4">
                                ...
                                <select id="prefix-ind-change" name="prefix" className="form-select" value={formData.prefix} onChange={handleChange} required>
                            ...
                            {formData.prefix === 'อื่นๆ' && (
                                <div className="col-md-4">
                                    ...
                                    <input type="text" id="custom-prefix-ind-change" className="form-control" value={customPrefix} onChange={(e) => setCustomPrefix(e.target.value)} placeholder="เช่น ดร., ผศ." required />
                                </div>
                            )}
                            <div className="col-md-4"> <label htmlFor="firstName-ind-change" className="form-label">ชื่อ*</label> <input type="text" id="firstName-ind-change" name="firstName" className="form-control" value={formData.firstName} onChange={handleChange} required /> </div>
                            <div className="col-md-4"> <label htmlFor="lastName-ind-change" className="form-label">นามสกุล*</label> <input type="text" id="lastName-ind-change" name="lastName" className="form-control" value={formData.lastName} onChange={handleChange} required /> </div>
                            ...
                            <div className="col-12"> <label htmlFor="address-ind-change" className="form-label">ที่อยู่*</label> <textarea id="address-ind-change" name="address" rows="3" className="form-control" value={formData.address} onChange={handleChange} required></textarea> </div>
                            <div className="col-md-6"> <label htmlFor="phone-ind-change" className="form-label">หมายเลขโทรศัพท์*</label> <input type="tel" id="phone-ind-change" name="phone" className="form-control" value={formData.phone} onChange={handleChange} maxLength="10" pattern="[0-9]{10}" title="กรุณากรอกหมายเลขโทรศัพท์ 10 หลัก" required /> </div>
                            <div className="col-md-6"> <label htmlFor="email-ind-change" className="form-label">E-mail*</label> <input type="email" id="email-ind-change" name="email" className="form-control" value={formData.email} onChange={handleChange} required /> </div>
                            <div className="col-md-6"> <label htmlFor="lineId-ind-change" className="form-label">Line-ID*</label> <input type="text" id="lineId-ind-change" name="lineId" className="form-control" value={formData.lineId} onChange={handleChange} required /> </div>
                            ...
                            <div className="col-12 mt-4">
                                ...
                                <input className={`form-control ${fileError ? 'is-invalid' : ''}`} type="file" id="idCardCopy-change" name="idCardCopy" onChange={handleChange} required accept="application/pdf" />
